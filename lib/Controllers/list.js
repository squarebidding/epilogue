...
List.prototype.fetch = function(req, res, context) {
  var self = this,
      ...
      defaultCount = 100,
      count = +context[this.resource.count.param] || +req.query[this.resource.count.param] || defaultCount,
  ...
  if(!isNaN(parseInt(context.page)) || !isNaN(parseInt(req.query.page))) {
    var page = context.page || req.query.page || 0;
    offset += (page > 0 ? --page : page) * count;
  }
